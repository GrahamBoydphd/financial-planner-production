...
async fn main() {
    ...
    let protected_routes = Router::new()
        ...
        .route("/api/funds/:id", get(handlers::funds::get_fund).delete(handlers::funds::delete_fund).put(handlers::funds::update_fund))
        
        // Companies
        .route("/api/companies", post(handlers::companies::create_company).get(handlers::companies::get_companies))
        .route("/api/companies/:id", get(handlers::companies::get_company).delete(handlers::companies::delete_company).put(handlers::companies::update_company))
