...
| **2. The Correction**  | Pooling dynamics & Non-Ergodic math.                                                                                                                                                                                                                                                                                                                                                                                   | **DONE**    | A simple fund with $N$ companies. $n$ of them are created by the investor, $N-n$ are automatically created by the engine. Each of the companies created by the investor uses the Company Version software.                                                                                            | **PENDING**  |
| **3. The Cloud (NOW)** | **Multi-Tenant User Layer.**                                                                                                                                                                                                                                                                                                                                                                                           | **ACTIVE**  | **Shared Auth Infrastructure.**<br>                                                                                                                                                                                                                                                                   | **ACTIVE**   |
| **4. The Economy**     | Tokenized Billing (Pay per Run).<br>Upgraded Business Modelling (BM) with more sophisticated input options and simulation parameters, and a low-level business model commentary in the output. Including  shocks, both shocks with / unique to a company, and economy-wide shocks affecting all companies, with the potential for a given shock to benefit some and harm others. Include the degree of non-ergodicity. | *NEXT*      | **Portfolio Wrapper:** Runs $N$ Company sims.<br>Implementation of "Waterfall".<br>Option of pooling in each fund, key investor metrics measured.<br>Do profit pooling between the N companies in the fund; and a monte carlo over M clones of the whole fund, without profit pooling between clones. | *NEXT*       |
| **5. The Diagnosis**   | Automated Business Model Analysis (AI).<br>Higher quality more comprehensive business model diagnosis and output. This will likely be an API call to dedicated Gemini agent with a good set of instructions                                                                                                                                                                                                            | *PLANNED*   | A full simulation of an economy of $M$ companies, $N$ of which are in the investor's fund, $n$ created by the investor.<br><br>Automated Portfolio Optimization.                                                                                                                                      | *PLANNED*    |
| **6. The Ecosystem**   | **Full Production:** Enterprise features.                                                                                                                                                                                                                                                                                                                                                                              | *TARGET*    | **Full Production:** Multi-Fund management.                                                                                                                                                                                                                                                           | *TARGET*     |
...
## 3. The Physics of Pooling (Math Specification)
*The simulation logic differs strictly between tracks.*
...
* **Simulation:** $M$ Clones of the **Entire Fund**.
...
## 4. The "3-Tier" Hierarchy (Target State)
