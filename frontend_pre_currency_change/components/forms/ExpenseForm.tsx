...
import { api, ExpenseItem, getCurrencySymbol } from '@/lib/api';
  ...
  useEffect(() => {
    ...
    const fetchCurrency = async () => {
        try {
            ...
            const code = p.company?.currency_code || p.company?.fund?.currency_code || 'USD';
            if (active) setCurrency(getCurrencySymbol(code));
        } catch (e) {
