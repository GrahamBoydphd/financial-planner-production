...
An elegant solution has been implemented to enforce the sorting order of Risk and Growth Rates in the stream summary cards. The sorting step has been injected before mapping `item.volatility_configs` in both `ClientPage.tsx` and `page.tsx` for both Revenue and Expense lists.

Here are the updated files containing the full code:

<file path='frontend/app/plan/[planId]/inputs/ClientPage.tsx'>'use client';
...
<file path='frontend/app/plan/[planId]/inputs/page.tsx'>'use client';
